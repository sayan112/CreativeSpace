  ...
  return (
    <div className="gig">
      <div className="container">
        <div className="left">
          <span className="breadcrambs">
            CreativeSpace {">"} Graphics& Design
          </span>
          ...
          <div className="seller">
            ...
            <div className="box">
              <div className="items">
                ...
                <div className="item">
                  <span className="title">Last Delhivery</span>
                ...
                <div className="item">
                  ...
                  <span className="desc">English,Bengali,Hindi</span>
                </div>
              </div>
              <hr />
              <p>
        ...
        <div className="right">
          ...
          <p>
            ...
            description that you give me , Lets make something unique 🖼️
          </p>
          ...
          <div className="leftfeatures">
            ...
            <div className="item">
              <img src={greencheck} alt="img" />
              <span>one to one talk 10 min </span>
            </div>
            <div className="item">
              <img src={greencheck} alt="img" />
              <span>No spaming</span>
            </div>
          </div>
